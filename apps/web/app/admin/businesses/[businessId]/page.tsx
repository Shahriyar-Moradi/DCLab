...
export default function BusinessPage() {
  ...
  return <div>
    <ProductPageHeader
      breadcrumbs={[{ label: businessMode ? "Business administration" : "Businesses", href: root }, { label: business.name }]}
      title={business.name}
      description={`${business.slug} · ${business.legal_name ?? "No legal name"} · ${business.industry ?? "Industry not set"}`}
    />
...
function Stat({ label, value }: { label: string; value: number }) { return <MetricCard label={label} value={String(value)} />; }
