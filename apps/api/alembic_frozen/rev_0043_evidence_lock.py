"""Frozen 0043 evidence-lock trigger SQL.

Copied from ``app.db.evidence_lock`` at the revision that installed these
triggers. Do not import the live module; later lock-predicate changes must not
alter 0043. Runtime stamping still lives in the live evidence-lock service.
"""
