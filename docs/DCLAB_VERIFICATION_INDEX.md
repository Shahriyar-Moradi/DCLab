...
(product/document baseline `c91b05a`, Alembic `0058_simulation_workspace`,
2026-09-11).
...
| [DCLAB_DATABASE_ARCHITECTURE.md](DCLAB_DATABASE_ARCHITECTURE.md) | **HISTORICAL freeze (0053)** | Physical schema, FKs, indexes, JSONB risks at `0053_pipeline_run_branch` | Alembic head + `models.py` + pg_catalog; current truth is **0058** |
| [DCLAB_DATABASE_MIGRATION_MAP.md](DCLAB_DATABASE_MIGRATION_MAP.md) | **HISTORICAL map** | Redesign object map through 0053; 0054 addendum at top | Written at 0053; its addendum is superseded by current head **0058** |
| [DCLAB_API_REFERENCE.md](DCLAB_API_REFERENCE.md) | **HISTORICAL** | Runtime OpenAPI operations (then 94) | FastAPI `app.openapi()` at an older SHA; current truth is **167** operations |
...
| [DCLAB_DATABASE_ERD.md](DCLAB_DATABASE_ERD.md) | **HISTORICAL** | Mermaid ERD | Frozen at Alembic **0039**; current truth is **0058** |
