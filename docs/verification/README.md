...
| [S0_P03A_WORKSPACE_SELECTION.md](S0_P03A_WORKSPACE_SELECTION.md) | **CURRENT** | Active workspace contract; ADR 0003; `0058_simulation_workspace` | — |
| [S0_P04A_SIMULATION_INSIGHTS.md](S0_P04A_SIMULATION_INSIGHTS.md) | **CURRENT** | SimulationRun/Insights tenancy; ADR 0004; `0058_simulation_workspace` | — |
...
| [../DCLAB_DATABASE_MIGRATION_MAP.md](../DCLAB_DATABASE_MIGRATION_MAP.md) | **HISTORICAL map + 0054 addendum** | Redesign spine through 0053; 0054 is current head | Omitting `needs_input` |
...
S0-P01B fails CI if a document marked CURRENT contradicts the Alembic head in
`contracts/truth_baseline.json`, or if `/v1` / table / OpenAPI snapshots drift.
