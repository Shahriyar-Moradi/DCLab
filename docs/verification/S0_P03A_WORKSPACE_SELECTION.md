...
Status: VERIFIED (API + source + drift); browser selector E2E added, local Playwright NOT_TESTED (CI required)
...
Known limitations: capability matrix and 403-vs-404 standardization remain S0-P03B; local Playwright E2E may be NOT_TESTED
